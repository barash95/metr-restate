...
//        }
        ...
        $user_email = $this->authService->getIdentity();
    ...
    public function logout()
    {
        ...
        if ($this->authService->getIdentity()==null) {
            throw new \Exception('Менеджер не авторизован!');
        }
    ...
    public function filterAccess($controllerName, $actionName)
    {
      ...
      //var_dump($this->config['controllers']);
        ...
        if ($mode!='restrictive' && $mode!='permissive')
            throw new \Exception('Неверный режим фильтра доступа (ожидаемый либо ограничительный, либо разрешающий режим');
        
        if (isset($this->config['controllers'][$controllerName])) {
            $items = $this->config['controllers'][$controllerName];
            //var_dump($items);
            ///echo "aaa".$this->authService->hasIdentity();
            //exit();
